    ...
    <nav className="bg-[#1e3a8a] text-white shadow-md border-b-4 border-green-600 relative z-50">
      <div className="container mx-auto px-4 py-3 md:py-4 md:min-h-20 flex flex-wrap md:flex-nowrap items-center justify-between">
        ...
        <div className="w-full md:w-auto hidden peer-checked:flex flex-col md:flex md:flex-row items-start md:items-center mt-4 md:mt-0 gap-2 md:gap-8 text-sm font-bold uppercase tracking-wide pb-4 md:pb-0 border-t border-blue-800/50 md:border-0 pt-4 md:pt-0">
          <Link href={`/?lang=${lang}`} className="block w-full md:inline-block whitespace-nowrap py-2 md:py-0 hover:text-green-400 transition-colors">
            {t.home}
          </Link>
          <Link href={`/?sector=public&lang=${lang}`} className="block w-full md:inline-block whitespace-nowrap py-2 md:py-0 hover:text-green-400 transition-colors">
            {t.public}
          </Link>
          <Link href={`/?sector=private&lang=${lang}`} className="block w-full md:inline-block whitespace-nowrap py-2 md:py-0 hover:text-green-400 transition-colors">
            {t.private}
          </Link>
          <Link href={`/blog?lang=${lang}`} className="block w-full md:inline-block whitespace-nowrap py-2 md:py-0 hover:text-green-400 transition-colors">
            {t.blog}
          </Link>
